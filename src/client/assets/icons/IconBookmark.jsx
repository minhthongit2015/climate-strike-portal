...
import SavedPostsDialogService from '../../app/services/SavedPostsDialogService';
...
export default React.memo((props) => {
  ...
  return (
    ...
    >
      ...
      <g id="9eb32880-cd59-408f-bb6c-fb8e4b5a29fb" data-name="Layer 2">
        <g id="8d1842d0-f7ea-40c3-b5cf-3b83ca76691e" data-name="Capa 1">
